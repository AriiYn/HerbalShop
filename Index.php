    ...
    <header>
        <div class="navbar">
            ...
            <div class="navigation">
                <ul>
                    <li><a href="#">Home</a></li>
                    <li><a href="role_admin/profil/profil_admin.php">Profil</a></li>
                    <li><a href="role_admin/pelanggan/data_pelanggan.php">Data Pelanggan</a></li>
                    <li><a href="role_admin/kategori/data_kategori.php">Data Kategori</a></li>
                    <li><a href="role_admin/produk/data_produk.php">Data Produk</a></li>
