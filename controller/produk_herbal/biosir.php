        ...
        <div class="flex">
            <div class="cardproduk">
                <div class="imgproduk-cardproduk">
                    <img src="../../Img/Herbal/BIOSIR Herb8.png" height="500px" width="500px">
                </div>
            </div>
            <div class="text" style="padding: 20px; margin: 20px; font-family: Verdana;">
                 <h1>BIOSIR</h1><br><br>
                 <a><p><b>KEGUNAAN</b></p>Membantu meringankan gejala wasir</a><br>
                <a><p><b>KOMPOSISI</b></P>
                    <p>- Daun Wungu (Graptophylli folium ekstrak)</p>
                    <p>- Temulawak (Curcumae rhizome ekstrak)</p>
                    <p>- Pegagan (Centellae herba ekstrak)</p>
                    <p>- Sambiloto (Andrographidis herba ekstrak)</p>
                </a>
                 <a><p><b>Aturan Pakai</b></p>Dewasa : 3 x 1 kapsul sehari</a><br>
                 <a><p><b>Ajuran</b></p>Jika tidak memiliki masalah lambung, diminum 1 jam sebelum makan.</a><br><br>
                 <a><p><b>Harga</b></p>Rp 90.000 (75/20)</a><br><br><br>
                 50 kapsul @500mg<br><br>
                 <div class="block" style="padding: 20px;">
                    <a href="https://shp.ee/tet83vk" class="btn-pesan">Pesan</a>
                </div>
            </div>
        </div>
