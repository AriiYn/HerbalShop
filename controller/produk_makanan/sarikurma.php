        ...
        <div class="flex">
            <div class="cardproduk">
                <div class="imgproduk-cardproduk">
                    <img src="../../Img/Health/SARKUM Health9.png" height="500px" width="500px">
                </div>
            </div>
            <div class="text" style="padding: 20px; margin: 20px; font-family: Verdana;">
                 <h1>SARI KURMA (SARKUM)</h1><br>
                 <a><p><b>KEGUNAAN</b></P><br>Digunakan secara tradisional untuk kesehatan badan.</a><br><br>
                 <a><p><b>KOMPOSISI</b></P><br>100% sari kurma</a><br><br>
                 <a><p><b>Harga</b></p><br>Rp 50.000 (45/11)</a><br><br><br>
                 350 gr<br><br>
                 <div class="block" style="padding: 20px;">
                    <a href="https://shp.ee/bspsp3k" class="btn-pesan">Pesan</a>
                </div>
            </div>
        </div>
    <footer>
