        ...
        <div class="flex">
            <div class="cardproduk">
                <div class="imgproduk-cardproduk">
                    <img src="../../Img/Health/robusta Health13.png" height="500px" width="500px">
                </div>
            </div>
            <div class="text" style="padding: 20px; margin: 20px; font-family: Verdana;">
                <h1>HANIA REALCO BLACK COFFEE FINE ROBUSTA</h1><br>
                 <a>100% kopi bubuk robusta</a><br><br>
                 <a><p><b>Harga</b></p><br>Rp 45.000 (35/7)</a><br><br><br>
                 10 sachets @10 gram<br><br>
                 <div class="block" style="padding: 20px;">
                    <a href="https://shp.ee/iwcf5nf" class="btn-pesan">Pesan</a>
                </div>
            </div>
        </div>
