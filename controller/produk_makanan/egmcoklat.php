        ...
        <div class="flex">
            <div class="cardproduk">
                <div class="imgproduk-cardproduk">
                    <img src="../../Img/Health/egm cokelat pouch Health12.png" height="500px" width="500px">
                </div>
            </div>
            <div class="text" style="padding: 20px; margin: 20px; font-family: Verdana;">
                 <h1>ETTA GOAT MILK (EGM) COKLAT</h1><br>
                 <a>Susu kambing bubuk ettawa dengan krim bubuk rasa cokelat.</a><br>
                 <a><p><b>KOMPOSISI</b></P>Susu kambing Etawa bubuk & gula</a><br><br>
                 <a><p><b>Harga</b></p><br>Rp 85.000 (70/20)</a><br><br><br>
                 10 sachets x 25 gr<br><br>
                 <div class="block" style="padding: 20px;">
                    <a href="https://shp.ee/dbkgpq6" class="btn-pesan">Pesan</a>
                </div>
            </div>
        </div>
