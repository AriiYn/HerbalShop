...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="update_profil1.php" class="needs-validation" novalidate>
            <?php
                include("../../koneksi.php"); 
                $id_admin = $_GET['id'];
                $sql = mysqli_query($koneksi,"SELECT * FROM login_admin WHERE id_admin='$id_admin'");
                $a = mysqli_fetch_array($sql);
            ?>
        <body id="bg-login">
            <div class="form-login">
                <h2>Ubah Data Admin</h2><br>
                <a href="profil_admin.php" class="btn btn-primary" style="background-color: #068622;" type="submit">Kembali</button></a><br><br>
