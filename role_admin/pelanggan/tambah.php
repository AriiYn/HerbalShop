...
<body id="bg-login">
    <div class="form-login">
        <h2>Tambah Data Pelanggan</h2>
            <input type="text" name="id_pelanggan" placeholder="Id Pelanggan" class="form-control" id="validationCustom01" required>
            ...
            <input type="text" name="password" placeholder="Password" class="form-control" id="validationCustom01" required>
