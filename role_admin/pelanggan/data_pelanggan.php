...
<body>
  ...
  <?php 
  include("../../koneksi.php");
  $sql = mysqli_query($koneksi,"SELECT * FROM login_pelanggan");
  while($d = mysqli_fetch_array($sql)){
   ?>
    <tr>
      ...
      <td>
        <a href="edit1.php?id=<?php echo $d['id_pelanggan']; ?>" class="btn btn-primary" style="background-color: #068622;">Ubah</a> | <a href="delete.php?id=<?php echo $d['id_pelanggan']; ?>" class="btn btn-danger">delete</a>
      </td>
      </tr>
  <?php } ?>
  </tbody>
