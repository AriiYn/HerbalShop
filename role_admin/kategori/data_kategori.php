  ...
  while($d = mysqli_fetch_array($sql)){
   ?>
    <tr>
      ...
      <td>
        <a href="edit.php?id=<?php echo $d['id_category']; ?>" class="btn btn-primary" style="background-color: #068622;">Ubah</a> | <a href="delete.php?id=<?php echo $d['id_category']; ?>" class="btn btn-danger">delete</a>
      </td>
      </tr>
  <?php } ?>
  </tbody>
